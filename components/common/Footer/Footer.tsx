      ...
      <Container>
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            {storeInfo?.address.city ? (
              <a href={`/`} className={s.link}>
                <AddLocationAltIcon /> &nbsp;{storeInfo.address.city}
              </a>
            ) : null}
            <br />
            {storeInfo?.phone ? (
              <a href={`tel:${storeInfo.phone}`} className={s.link}>
                <PhoneIcon /> &nbsp;{storeInfo.phone}
              </a>
            ) : null}
          </div>
            ...
            <div className="flex space-x-6 items-center h-10">
              {storeInfo ? (
                <>
                  ...
                  {storeInfo.socialMediaLinks?.pinterest ? (
                    <a
                      className={s.link}
                      aria-label="Pinterest"
                      href={storeInfo.socialMediaLinks?.pinterest}
                    >
                      <PinterestIcon/>
                    </a>
                  ) : null}
                  ...
                  {storeInfo.socialMediaLinks?.linkedin ? (
                    <a
                      className={s.link}
                      aria-label="Linkedin"
                      href={storeInfo.socialMediaLinks?.linkedin}
                    >
                      <LinkedInIcon />
                    </a>
                  ) : null}
        ...
        <div className="pt-6 pb-10 flex flex-col md:flex-row justify-between items-center space-y-4 text-accent-6 text-sm">
          <div>
            <span>
              Powered By &copy;
              <Link href="https://makemycommerce.in/">
                <a> Make My Commerce</a>
              </Link>{" "}
            </span>
          </div>
